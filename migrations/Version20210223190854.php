 ...
 */
final class Version20210223190854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE manual_log (id INT AUTO_INCREMENT NOT NULL, request VARCHAR(255) DEFAULT NULL, body VARCHAR(11255) DEFAULT NULL, answer MEDIUMTEXT DEFAULT NULL, result VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE manual_log');
