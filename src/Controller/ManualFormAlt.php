...
class ManualFormAlt extends AbstractController
{
    private $taskLogger;
    private $connector;
    private $client;
    ...
    /**
     * @Route("/manualformalt", name = "manual_form_alt")
     */
    public function form(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                if ($response->getStatusCode() == '200') {                      //error when ip for MArket not in whitelist!
                    ...
                    $this->taskLogger->ManualLog($form['Request']->getData(), $response->getStatusCode(),
        ...
        return $this->render('alt/manual_alt.html.twig', array(
            'form' => $form->createView(), 'form3' => $form3->createView()
        ));
    }
}