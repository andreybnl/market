...
class DetailController extends BaseController
{
    ...
    {
        $scheduledCommand = $this->getDoctrine()->getManager()->getRepository(ScheduledCommand::class)
    ...
    public function saveAction(Request $request)
    {
        ...
        // $commandName = $scheduledCommand->getCommand()->getCode();  //mur   //for Entity type only!
        ...
        if ($scheduledCommandForm->isSubmitted() && $scheduledCommandForm->isValid()) {
            ...
            if (null === $scheduledCommand->getId()) {
                ...
                $taskLogger->userLog($this->getUser()->getUsername(),' new Cron ' . $scheduledCommand->getName(), 'sucess' );
